...
var SearchApartment = /** @class */ (function () {
    function SearchApartment() {
    }
    return SearchApartment;
}());

var AddRentDate = /** @class */ (function () {
...
var DatesModelFirstAdd = /** @class */ (function () {
    function DatesModelFirstAdd() {
    }
    return DatesModelFirstAdd;
}());

var DateModelBM = /** @class */ (function () {
    function DateModelBM() {
    }
    return DateModelBM;
}());
...
var RegistUser = /** @class */ (function () {
    function RegistUser(name, surname, username, pass, gender) {
        this.name = name;
...
var AddDatesComponent = /** @class */ (function () {
    function AddDatesComponent(hostService, fb, router, storageService) {
        this.hostService = hostService;
        this.fb = fb;
        this.router = router;
        this.storageService = storageService;
    }
    AddDatesComponent.prototype.ngOnInit = function () {
    ...
    AddDatesComponent.prototype.onAdd = function () {
        this.dateModel.CheckedDates.push(this.addForm.value.date);
        alert("Date vas added");
    };
    AddDatesComponent.prototype.onDone = function () {
        var _this = this;
        this.hostService.addDates(this.dateModel).subscribe(function (data) {
            _this.storageService.setApartmentID(_this.dateModel.ApartmanID);
            _this.router.navigate(['host/apartments/pictures']);
        });
    };
...
var AdminService = /** @class */ (function () {
    ...
    AdminService.prototype.SearchUsers = function (userRole, userGender, username) {
        var httpOptions = {
        ...
        return this.http.get(this.userUri + "SearchUsers", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.getAllUsers = function () {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.get(this.userUri + "GetUsers", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.getAllReservations = function () {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.get(this.reservationUri + "GetAllReservations", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.getAllApartments = function () {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.get(this.apartmentUri + "GetAllApartments", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.getCommentsForApartment = function (apartmentID) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('apartmentID', apartmentID)
        };
        return this.http.get(this.apartmentUri + "GetAllCommentsForApartment", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.changeApartment = function (apartment) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.patch(this.apartmentUri + "ChangeApartment", apartment, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.changeUserStatus = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.patch(this.userUri + "ChangeUserStatus", id, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.deleteApartmentComment = function (commentId) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('commentId', commentId)
        };
        return this.http.delete(this.apartmentUri + "DeleteApartmentComment", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
        ;
    };
    AdminService.prototype.deleteApartment = function (apartmentId) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('apartmentId', apartmentId)
        };
        return this.http.delete(this.apartmentUri + "DeleteApartment", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
        ;
    };
    AdminService.prototype.CreateHost = function (user) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.put(this.userUri + "CreateHost", user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.GetAllAmenities = function () {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.get(this.amenitieUri + "GetAllAmenities", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.DeleteAmenitie = function (amenitieId) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('amenitieId', amenitieId)
        };
        return this.http.delete(this.amenitieUri + "DeleteAmenitie", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.AddAmenitie = function (amenitieName) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('amenitieName', amenitieName)
        };
        return this.http.delete(this.amenitieUri + "AddAmenitie", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in admin service:  " + e.error.Message)); }));
    };
    AdminService.prototype.GetSearchApartments = function (apartmentDetails) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.put(this.apartmentUri + "GetSearchApartments", apartmentDetails, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in home service:  " + e.error.Message)); }));
    };
    AdminService.prototype.GetSearchReservations = function (username, status) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('username', username).set('status', status)
        };
        return this.http.get(this.reservationUri + "GetSearchReservations", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service:  " + e.error.Message)); }));
    };
...
var AmenitieComponent = /** @class */ (function () {
    function AmenitieComponent(adminService, fb, router) {
    ...
    AmenitieComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.adminService.GetAllAmenities().subscribe(function (data) {
            data;
            console.log(data);
            _this.allAmenities = data;
        });
    };
    AmenitieComponent.prototype.deleteAmenitie = function (event) {
        var _this = this;
        var target = event.target || event.srcElement || event.currentTarget;
        var idAttr = target.attributes.id;
        var id = idAttr.nodeValue; //id kliknutog 
        this.adminService.DeleteAmenitie(id).subscribe(function (data) {
            //brisi sa view-a:
            var comm = _this.allAmenities.find(function (x) { return x.Id == id; });
            var idx = _this.allAmenities.indexOf(comm);
            _this.allAmenities.splice(idx, 1);
        });
    };
    AmenitieComponent.prototype.onSubmit = function () {
        var _this = this;
        this.adminService.AddAmenitie(this.addForm.value.Name).subscribe(function (data) {
...
var ApartmentsComponent = /** @class */ (function () {
    function ApartmentsComponent(adminService, homeService, fb, router, storageService) {
        this.adminService = adminService;
    ...
    ApartmentsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.adminService.getAllApartments().subscribe(function (data) {
            _this.AllApartments = data;
            _this.FiltredApartments = data; //
            console.log(_this.AllApartments);
            //amenities for search:
            _this.homeService.GetAmenitieNames().subscribe(function (names) {
                _this.amNames = names;
                _this.addCheckboxes();
                _this.amNames.forEach(function (element) {
                    console.warn(element);
                });
            });
        });
    };
    ApartmentsComponent.prototype.editApartment = function (id) {
        // const target = event.target || event.srcElement || event.currentTarget;
        // const idAttr = target.attributes.id;
        // const id = idAttr.nodeValue; //id kliknutog button-a
        console.log(id);
        var apartment = this.AllApartments.find(function (x) { return x.ID == id; });
        this.storageService.setApartment(apartment);
        this.router.navigate(['/admin/apartments/edit']);
    };
    ApartmentsComponent.prototype.onSearch = function () {
        var _this = this;
        ...
        this.adminService.GetSearchApartments(searchApartment).subscribe(function (data) {
            _this.FiltredApartments = data;
        });
    };
    ApartmentsComponent.prototype.addCheckboxes = function () {
        var _this = this;
        this.amNames.map(function (o, i) {
            var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]();
            _this.searchForm.controls.amNames.push(control);
        });
    };
    ApartmentsComponent.prototype.reset = function () {
        this.FiltredApartments = this.AllApartments;
    };
    ApartmentsComponent.prototype.sortLow = function () {
        this.FiltredApartments.sort(function (a, b) { return a.PricePerNight - b.PricePerNight; });
    };
    ApartmentsComponent.prototype.sortHigh = function () {
        this.FiltredApartments.sort(function (a, b) { return b.PricePerNight - a.PricePerNight; });
    };
...
var EditApartmentComponent = /** @class */ (function () {
    function EditApartmentComponent(hostService, adminService, storageService, fb, router) {
        this.hostService = hostService;
        this.adminService = adminService;
        this.storageService = storageService;
        this.fb = fb;
    ...
    EditApartmentComponent.prototype.onChange = function () {
        var _this = this;
        ...
        this.hostService.changeApartment(this.apartment).subscribe(function (data) {
            _this.router.navigate(["/admin/apartments"]);
        });
    };
    EditApartmentComponent.prototype.onDelete = function () {
        var _this = this;
        this.hostService.deleteApartment(this.apartment.ID).subscribe(function (data) {
            _this.router.navigate(["/admin/apartments"]);
        });
    };
    EditApartmentComponent.prototype.getAllComments = function () {
        var _this = this;
        this.hostService.getCommentsForApartment(this.apartment.ID).subscribe(function (data) {
            _this.apartmentComments = data;
            console.warn(_this.apartmentComments);
        });
    };
    EditApartmentComponent.prototype.returnBack = function () {
        this.router.navigate(["/admin/apartments"]);
    };
    EditApartmentComponent.prototype.GetAllAmenitiNames = function () {
        var _this = this;
        this.hostService.GetAmenitieNames().subscribe(function (names) {
            _this.amNames = names;
            console.log(_this.amNames);
            _this.addCheckboxes();
            _this.amNames.forEach(function (element) {
                console.warn(element);
            });
    ...
    EditApartmentComponent.prototype.addCheckboxes = function () {
        var _this = this;
        this.amNames.map(function (o, i) {
            var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]((_this.apartment.Amenities.indexOf(o) != -1)); //
            _this.editForm.controls.amNames.push(control);
        });
        this.getAllComments();
    };
    EditApartmentComponent.prototype.deletePicture = function (event) {
        var _this = this;
        var target = event.target || event.srcElement || event.currentTarget;
        var idAttr = target.attributes.id;
        var id = idAttr.nodeValue; //id kliknutog button-a 
        var picture = id;
        var idx = this.apartment.Pictures.indexOf(picture);
        var sendPicture = picture.split("localhost:8080/")[1];
        console.log(sendPicture);
        this.hostService.DeltePicture(this.apartment.ID, sendPicture).subscribe(function (data) {
            _this.apartment.Pictures.splice(idx, 1);
        });
    };
    EditApartmentComponent.prototype.addNewPicutres = function () {
        this.storageService.setApartmentID(this.apartment.ID);
        this.router.navigate(['host/apartments/pictures']);
    };
    EditApartmentComponent.prototype.deleteComment = function (id) {
        // const target = event.target || event.srcElement || event.currentTarget;
        // const idAttr = target.attributes.id;
        // const id = idAttr.nodeValue; //id kliknutog comment-a
        var _this = this;
        this.adminService.deleteApartmentComment(id).subscribe(function (data) {
            //brisi sa view-a:
            var comm = _this.apartmentComments.find(function (x) { return x.Id == id; });
            var idx = _this.apartmentComments.indexOf(comm);
            _this.apartmentComments.splice(idx, 1);
        });
    };
...
var CreateHostComponent = /** @class */ (function () {
    function CreateHostComponent(fb, router, adminService) {
        this.fb = fb;
        this.router = router;
        this.adminService = adminService;
    ...
    CreateHostComponent.prototype.ngOnInit = function () {
    };
    CreateHostComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.registerForm.value.password === this.registerForm.value.confirmPassword) {
            ...
            this.adminService.CreateHost(this.registUser).subscribe(function (data) {
                alert("Host was created");
                console.log(_this.registUser);
...
var ReservationsComponent = /** @class */ (function () {
    function ReservationsComponent(adminService, fb) {
        this.adminService = adminService;
        this.fb = fb;
    ...
    ReservationsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.adminService.getAllReservations().subscribe(function (data) {
            _this.AllReservations = data;
            _this.FiltredReservations = data;
            console.log(_this.AllReservations);
        });
    };
    ReservationsComponent.prototype.onSearch = function () {
        var _this = this;
        this.adminService.GetSearchReservations(this.searchForm.value.guestUsername, this.searchForm.value.reservationStatus).subscribe(function (data) {
            _this.FiltredReservations = data;
            console.warn(_this.FiltredReservations);
        });
    };
    ReservationsComponent.prototype.reset = function () {
        this.FiltredReservations = this.AllReservations;
    };
    ReservationsComponent.prototype.sortLow = function () {
        this.FiltredReservations.sort(function (a, b) { return a.TotalPrice - b.TotalPrice; });
    };
    ReservationsComponent.prototype.sortHigh = function () {
        this.FiltredReservations.sort(function (a, b) { return b.TotalPrice - a.TotalPrice; });
    };
...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(fb, adminService) {
        this.fb = fb;
        this.adminService = adminService;
    ...
    UsersComponent.prototype.changeStatus = function (id) {
        var _this = this;
        // const target = event.target || event.srcElement || event.currentTarget;
        // const idAttr = target.attributes.id;
        // const id = idAttr.nodeValue; //id kliknutog comment-a
        console.log(id);
        this.adminService.changeUserStatus(id).subscribe(function (data) {
            ...
            if (_this.AllUsers !== _this.SearchedUsers)
                _this.SearchedUsers.forEach(function (user) {
                    if (user.ID == id) {
                        if (user.Blocked)
                            user.Blocked = false;
                        else
    ...
    UsersComponent.prototype.onSearch = function () {
        var _this = this;
        this.adminService.SearchUsers(this.searchForm.value.Role, this.searchForm.value.Gender, this.searchForm.value.Username).subscribe(function (data) {
            _this.SearchedUsers = data;
            console.log(_this.SearchedUsers);
        });
    };
    UsersComponent.prototype.onReset = function () {
...
var GuestService = /** @class */ (function () {
    ...
    GuestService.prototype.GetGuestReservations = function (guestId) {
        var httpOptions = {
        ...
        return this.http.get(this.reservationUri + "GetGuestReservations", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(console.error("Eror in guest service:  " + e.error.Message)); }));
    };
    GuestService.prototype.cancelReservationRequest = function (reservationId, status) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        ...
        return this.http.delete(this.reservationUri + "ChageReservationRequests", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
    };
    GuestService.prototype.GetGuestReservationRequest = function (guestId, status) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('guestId', guestId).set('status', status)
        };
        return this.http.get(this.reservationUri + "GetGuestReservationRequest", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
    };
...
var ApartmentDetailsComponent = /** @class */ (function () {
    function ApartmentDetailsComponent(homeService, storageService, fb, router) {
        this.homeService = homeService;
        this.storageService = storageService;
        this.fb = fb;
        this.router = router;
    ...
    ApartmentDetailsComponent.prototype.returnBack = function () {
        this.router.navigate(["/guest/apartments"]);
    };
    ApartmentDetailsComponent.prototype.GetApartmentAmenitieNames = function () {
        var _this = this;
        this.homeService.GetApartmentAmenitieNames(this.apartment.ID).subscribe(function (data) {
            _this.amNames = data;
            _this.getAllComments();
        });
    };
    ApartmentDetailsComponent.prototype.getAllComments = function () {
        var _this = this;
        this.homeService.getCommentsForApartment(this.apartment.ID).subscribe(function (data) {
            _this.apartmentComments = data;
            console.warn(_this.apartmentComments);
        });
    };
...
var GuestApartmentsComponent = /** @class */ (function () {
    function GuestApartmentsComponent(homeService, router, fb, storageService) {
        this.homeService = homeService;
        this.router = router;
        this.fb = fb;
        this.storageService = storageService;
    ...
    GuestApartmentsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.homeService.getActiveApartments().subscribe(function (data) {
            _this.ActiveApartments = data;
            _this.FiltredApartments = data;
            //amenities for search:
            _this.homeService.GetAmenitieNames().subscribe(function (names) {
                _this.amNames = names;
    ...
    GuestApartmentsComponent.prototype.moreDetails = function (id) {
        // const target = event.target || event.srcElement || event.currentTarget;
        // const idAttr = target.attributes.id;
        // const id = idAttr.nodeValue; //id kliknutog button-a
        var apartment = this.ActiveApartments.find(function (x) { return x.ID == id; });
        this.storageService.setGuestApartment(apartment);
        this.router.navigate(['guest/apartments/details']);
    };
    GuestApartmentsComponent.prototype.onSearch = function () {
        var _this = this;
        ...
        this.homeService.GetSearchApartments(searchApartment).subscribe(function (data) {
            _this.FiltredApartments = data;
        });
    };
    GuestApartmentsComponent.prototype.addCheckboxes = function () {
        var _this = this;
        this.amNames.map(function (o, i) {
            var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]();
            _this.searchForm.controls.amNames.push(control);
    ...
    GuestApartmentsComponent.prototype.reset = function () {
        this.FiltredApartments = this.ActiveApartments;
    };
    GuestApartmentsComponent.prototype.sortLow = function () {
        this.FiltredApartments.sort(function (a, b) { return a.PricePerNight - b.PricePerNight; });
    };
    GuestApartmentsComponent.prototype.sortHigh = function () {
        this.FiltredApartments.sort(function (a, b) { return b.PricePerNight - a.PricePerNight; });
    };
    ...
    return GuestApartmentsComponent;
}());
...
var GuestRequestsComponent = /** @class */ (function () {
    ...
    GuestRequestsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.guestService.GetGuestReservationRequest(2, 'Created').subscribe(function (data) {
            _this.createdReservations = data;
            console.log(_this.createdReservations);
            _this.guestService.GetGuestReservationRequest(2, 'Accepted').subscribe(function (data) {
                _this.acceptedReservations = data;
                console.log(_this.acceptedReservations);
            });
        });
    };
    GuestRequestsComponent.prototype.CancelRequest = function (event) {
        var _this = this;
        var target = event.target || event.srcElement || event.currentTarget;
        var idAttr = target.attributes.id;
        var id = idAttr.nodeValue; //id kliknutog button-a
        this.guestService.cancelReservationRequest(id, 'Canceled').subscribe(function (data) {
            var res = _this.acceptedReservations.find(function (x) { return x.ID == id; });
            if (res != undefined) {
                var idx = _this.acceptedReservations.indexOf(res);
                _this.acceptedReservations.splice(idx, 1);
            }
            res = _this.createdReservations.find(function (x) { return x.ID == id; });
            if (res != undefined) {
                var idx = _this.createdReservations.indexOf(res);
                _this.createdReservations.splice(idx, 1);
            }
        });
    };
...
var GuestReservationsComponent = /** @class */ (function () {
    function GuestReservationsComponent(guestService) {
        this.guestService = guestService;
        this.guestReservations = [];
        this.FiltredReservations = [];
    }
    GuestReservationsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.guestService.GetGuestReservations(localStorage.ID).subscribe(function (data) {
            _this.guestReservations = data;
            _this.FiltredReservations = data;
            console.log(_this.FiltredReservations);
        });
    };
    GuestReservationsComponent.prototype.sortLow = function () {
        this.FiltredReservations.sort(function (a, b) { return a.TotalPrice - b.TotalPrice; });
    };
    GuestReservationsComponent.prototype.sortHigh = function () {
        this.FiltredReservations.sort(function (a, b) { return b.TotalPrice - a.TotalPrice; });
    };
    ...
    return GuestReservationsComponent;
}());
...
var HomeApartmentDetailsComponent = /** @class */ (function () {
    function HomeApartmentDetailsComponent(homeService, storageService, fb, router) {
        this.homeService = homeService;
        this.storageService = storageService;
        this.fb = fb;
        this.router = router;
    ...
    HomeApartmentDetailsComponent.prototype.ngOnInit = function () {
        this.apartment = this.storageService.getGuestApartment();
        console.warn(this.apartment);
        this.editForm = this.fb.group({
    ...
    HomeApartmentDetailsComponent.prototype.returnBack = function () {
        this.router.navigate(["/home"]);
    };
    HomeApartmentDetailsComponent.prototype.GetApartmentAmenitieNames = function () {
        var _this = this;
        this.homeService.GetApartmentAmenitieNames(this.apartment.ID).subscribe(function (data) {
            _this.amNames = data;
            _this.getAllComments();
    ...
    HomeApartmentDetailsComponent.prototype.getAllComments = function () {
        var _this = this;
        this.homeService.getCommentsForApartment(this.apartment.ID).subscribe(function (data) {
            _this.apartmentComments = data;
            console.warn(_this.apartmentComments);
    ...
    return HomeApartmentDetailsComponent;
}());
...
var HomeService = /** @class */ (function () {
    ...
    HomeService.prototype.SearchUsers = function (userRole, userGender, username) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        ...
        return this.http.get(this.apartmentUri + "GetSearchApartments", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(console.error("Eror in admin service:  " + e.error.Message)); }));
    };
    HomeService.prototype.getActiveApartments = function () {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json' })
        };
        return this.http.get(this.apartmentUri + "GetActiveApartments", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(console.error("Eror in home service:  " + e)); }));
    };
    HomeService.prototype.getCommentsForApartment = function (apartmentID) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json' }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('apartmentID', apartmentID)
        };
        return this.http.get(this.apartmentUri + "GetCommentsForApartment", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(console.error("Eror in home service:  " + e.error.Message)); }));
    };
    HomeService.prototype.GetApartmentAmenitieNames = function (apartmentID) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json' }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('apartmentID', apartmentID)
        };
        return this.http.get(this.apartmentUri + "GetApartmentAmenitieNames", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(alert("Eror in home service:  " + e.error.Message)); }));
    };
    HomeService.prototype.GetSearchApartments = function (apartmentDetails) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json', }),
        };
        return this.http.put(this.apartmentUri + "GetSearchApartments", apartmentDetails, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(alert("Eror in home service:  " + e.error.Message)); }));
    };
    HomeService.prototype.GetAmenitieNames = function () {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json' })
        };
        return this.http.get(this.amenitieUri + "GetAmenitieNames", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(alert("Eror in host service:  " + e.error.Message)); }));
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(storageService, homeService, router, fb) {
        this.storageService = storageService;
        this.homeService = homeService;
        this.router = router;
        this.fb = fb;
    ...
    HomeComponent.prototype.moreDetails = function (id) {
        // const target = event.target || event.srcElement || event.currentTarget;
        // const idAttr = target.attributes.id;
    ...
    HomeComponent.prototype.addCheckboxes = function () {
        var _this = this;
        this.amNames.map(function (o, i) {
            var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]();
            _this.searchForm.controls.amNames.push(control);
    ...
    HomeComponent.prototype.sortLow = function () {
        this.FiltredApartments.sort(function (a, b) { return a.PricePerNight - b.PricePerNight; });
    };
    HomeComponent.prototype.sortHigh = function () {
        this.FiltredApartments.sort(function (a, b) { return b.PricePerNight - a.PricePerNight; });
    };
...
var HostService = /** @class */ (function () {
    ...
    HostService.prototype.addDates = function (dateModel) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.put(this.apartmentUri + "AddRentDates", dateModel, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
        ;
    };
    HostService.prototype.getHostReservations = function (hostId) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('hostId', hostId)
        };
        return this.http.get(this.reservationUri + "GetHostReservations", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.changeUserStatus = function (reservationId, status) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        ...
        return this.http.delete(this.reservationUri + "ChageReservationRequests", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.GetReservationRequests = function (hostId, status) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('hostId', hostId).set('status', status)
        };
        return this.http.get(this.reservationUri + "GetReservationRequests", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.getHostApartments = function (hostId) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('hostId', hostId)
        };
        return this.http.get(this.apartmentUri + "GetHostApartments", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e)); }));
    };
    HostService.prototype.ChangeStatusApartmentComment = function (commentId) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.patch(this.apartmentUri + "ChangeStatusApartmentComment?commentId=" + commentId, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
        ;
    };
    HostService.prototype.changeApartment = function (apartment) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.patch(this.apartmentUri + "ChangeApartment", apartment, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.getCommentsForApartment = function (apartmentID) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('apartmentID', apartmentID)
        };
        return this.http.get(this.apartmentUri + "GetAllCommentsForApartment", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.deleteApartment = function (apartmentId) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('apartmentId', apartmentId)
        };
        return this.http.delete(this.apartmentUri + "DeleteApartment", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
        ;
    };
    HostService.prototype.addApartment = function (apartmentBM) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.put(this.apartmentUri + "AddApartment", apartmentBM, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(console.error("Eror in host service:  " + e.error.Message)); }));
        ;
    };
    HostService.prototype.GetAmenitieNames = function () {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role })
        };
        return this.http.get(this.amenitieUri + "GetAmenitieNames", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.DeltePicture = function (apartmentId, picture) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('apartmentId', apartmentId).set('picture', picture)
        };
        return this.http.delete(this.apartmentUri + "DeletePicture", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.uploadDocument = function (document, apartmentID) {
        var httpOptions = {
        ...
        return this.http.post(this.userUri + "UploadPictures", document, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service, pictures problem :  " + e.error.Message)); }));
    };
    HostService.prototype.GetSearchHostApartments = function (apartmentDetails) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.put(this.apartmentUri + "GetSearchHostApartments", apartmentDetails, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.GetSearchHostReservations = function (username, status) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        ...
        return this.http.get(this.reservationUri + "GetSearchHostReservations", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service:  " + e.error.Message)); }));
    };
    HostService.prototype.addRentDate = function (rentDate) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.put(this.apartmentUri + "AddHostRentDate", rentDate, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service, rent date problem :  " + e.error.Message)); }));
    };
    HostService.prototype.GetHostApartmentRentDates = function (apartmanID) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('apartmanID', apartmanID)
        };
        return this.http.get(this.apartmentUri + "GetHostApartmentRentDates", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service, rent date problem :   " + e.error.Message)); }));
    };
    HostService.prototype.DeleteHostRentDate = function (dateID) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('dateID', dateID)
        };
        return this.http.delete(this.apartmentUri + "DeleteHostRentDate", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(alert("Eror in host service, delete rent date:  " + e.error.Message)); }));
    };
...
var EditHostApartmentComponent = /** @class */ (function () {
    function EditHostApartmentComponent(hostService, storageService, fb, fb2, router) {
        this.hostService = hostService;
        this.storageService = storageService;
        this.fb = fb;
        this.fb2 = fb2;
    ...
    EditHostApartmentComponent.prototype.ngOnInit = function () {
    ...
    EditHostApartmentComponent.prototype.onChange = function () {
        var _this = this;
        this.apartment.Type = this.editForm.value.Type;
        this.apartment.RoomNumber = this.editForm.value.RoomNumber;
        this.apartment.GuestNumber = this.editForm.value.GuestNumber;
        ...
        this.hostService.changeApartment(this.apartment).subscribe(function (data) {
            _this.router.navigate(["/host/apartments"]);
        });
    };
    EditHostApartmentComponent.prototype.onDelete = function () {
        var _this = this;
        this.hostService.deleteApartment(this.apartment.ID).subscribe(function (data) {
            _this.router.navigate(["/host/apartments"]);
        });
    };
    EditHostApartmentComponent.prototype.chageComment = function (event) {
        var _this = this;
        var target = event.target || event.srcElement || event.currentTarget;
        var idAttr = target.attributes.id;
        var id = idAttr.nodeValue; //id kliknutog comment-a
        this.hostService.ChangeStatusApartmentComment(id).subscribe(function (data) {
            _this.apartmentComments.forEach(function (comment) {
                if (comment.Id == id) {
                    if (comment.Blocked)
    ...
    EditHostApartmentComponent.prototype.getAllComments = function () {
        var _this = this;
        this.hostService.getCommentsForApartment(this.apartment.ID).subscribe(function (data) {
            _this.apartmentComments = data;
            console.warn(_this.apartmentComments);
            _this.getDateModels(); //vraca rentDates za apartment
        });
    };
    EditHostApartmentComponent.prototype.returnBack = function () {
        this.router.navigate(["/host/apartments"]);
    };
    EditHostApartmentComponent.prototype.GetAllAmenitiNames = function () {
        var _this = this;
        this.hostService.GetAmenitieNames().subscribe(function (names) {
            _this.amNames = names;
            _this.addCheckboxes();
    ...
    EditHostApartmentComponent.prototype.addCheckboxes = function () {
        var _this = this;
        this.amNames.map(function (o, i) {
            var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]((_this.apartment.Amenities.indexOf(o) != -1)); //
            _this.editForm.controls.amNames.push(control);
        });
        this.getAllComments();
    };
    EditHostApartmentComponent.prototype.deletePicture = function (event) {
        var _this = this;
        var target = event.target || event.srcElement || event.currentTarget;
        var idAttr = target.attributes.id;
        var id = idAttr.nodeValue; //id kliknutog button-a 
    ...
    EditHostApartmentComponent.prototype.addNewPicutres = function () {
        this.storageService.setApartmentID(this.apartment.ID);
        this.router.navigate(['host/apartments/pictures']);
    };
    EditHostApartmentComponent.prototype.getDateModels = function () {
        var _this = this;
        this.hostService.GetHostApartmentRentDates(this.apartment.ID).subscribe(function (data) {
            _this.apartmentDates = data;
        });
    };
    EditHostApartmentComponent.prototype.addRentDate = function () {
        var _this = this;
        ...
        this.hostService.addRentDate(rentDate).subscribe(function (data) {
            _this.getDateModels();
        });
    };
    EditHostApartmentComponent.prototype.deleteRentDate = function (id) {
        var _this = this;
        console.warn(id);
        this.hostService.DeleteHostRentDate(id).subscribe(function (data) {
            _this.getDateModels();
    ...
    return EditHostApartmentComponent;
}());
...
var HostApartmentsComponent = /** @class */ (function () {
    function HostApartmentsComponent(_sanitizer, hostService, fb, router, storageService, homeService) {
    ...
    HostApartmentsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.hostService.getHostApartments(localStorage.ID).subscribe(function (data) {
            _this.HostApartmants = data;
            _this.FiltredApartments = data; //
            console.warn(_this.FiltredApartments);
            //amenities for search:
            _this.homeService.GetAmenitieNames().subscribe(function (names) {
                _this.amNames = names;
                _this.addCheckboxes();
    ...
    HostApartmentsComponent.prototype.editApartment = function (id) {
        // const target = event.target || event.srcElement || event.currentTarget;
        // const idAttr = target.attributes.id;
        // const id = idAttr.nodeValue; //id kliknutog button-a
        var apartment = this.HostApartmants.find(function (x) { return x.ID == id; });
        this.storageService.setHostApartment(apartment);
        this.router.navigate(['host/apartments/edit']);
    };
    HostApartmentsComponent.prototype.onSearch = function () {
        var _this = this;
        ...
        this.hostService.GetSearchHostApartments(searchApartment).subscribe(function (data) {
            _this.FiltredApartments = data;
        });
    };
    HostApartmentsComponent.prototype.addCheckboxes = function () {
        var _this = this;
        this.amNames.map(function (o, i) {
            var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]();
            _this.searchForm.controls.amNames.push(control);
    ...
    HostApartmentsComponent.prototype.reset = function () {
        this.FiltredApartments = this.HostApartmants;
    };
    HostApartmentsComponent.prototype.sortLow = function () {
        this.FiltredApartments.sort(function (a, b) { return a.PricePerNight - b.PricePerNight; });
    };
    HostApartmentsComponent.prototype.sortHigh = function () {
        this.FiltredApartments.sort(function (a, b) { return b.PricePerNight - a.PricePerNight; });
    };
    ...
    return HostApartmentsComponent;
}());
...
var HostCreateApartmentComponent = /** @class */ (function () {
    function HostCreateApartmentComponent(hostService, fb, router, storageService) {
        this.hostService = hostService;
        this.fb = fb;
        this.router = router;
        this.storageService = storageService;
    ...
    HostCreateApartmentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.hostService.GetAmenitieNames().subscribe(function (names) {
            _this.amNames = names;
            _this.addCheckboxes();
    ...
    HostCreateApartmentComponent.prototype.createApartment = function () {
        var _this = this;
        this.AddApartmentInfos(this.addForm.value);
        this.apartment.HostID = localStorage.ID;
        this.hostService.addApartment(this.apartment).subscribe(function (data) {
            var apartmentID = data;
            _this.storageService.setApartmentID(apartmentID);
            _this.router.navigate(['apartment/dates']);
        });
    };
    HostCreateApartmentComponent.prototype.AddApartmentInfos = function (element) {
    ...
    HostCreateApartmentComponent.prototype.addCheckboxes = function () {
        var _this = this;
        this.amNames.map(function (o, i) {
            var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]();
            _this.addForm.controls.amNames.push(control);
        });
    };
    ...
    return HostCreateApartmentComponent;
}());
...
var HostRequestsComponent = /** @class */ (function () {
    function HostRequestsComponent(hostService) {
        this.hostService = hostService;
        this.createdReservations = [];
        this.acceptedReservations = [];
    }
    HostRequestsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.hostService.GetReservationRequests(3, 'Created').subscribe(function (data) {
            _this.createdReservations = data;
            console.log(_this.createdReservations);
            _this.hostService.GetReservationRequests(3, 'Accepted').subscribe(function (data) {
                _this.acceptedReservations = data;
                console.log(_this.acceptedReservations);
            });
        });
    };
    HostRequestsComponent.prototype.acceptRequest = function (event) {
        var _this = this;
        var target = event.target || event.srcElement || event.currentTarget;
        var idAttr = target.attributes.id;
        var id = idAttr.nodeValue; //id kliknutog button-a
        this.hostService.changeUserStatus(id, 'Accepted').subscribe(function (data) {
            _this.createdReservations.forEach(function (reservation) {
                if (reservation.ID == id) {
                    //prebaci u Accepted listu
                    var res = reservation;
                    res.Stauts = 'Accepted';
                    _this.acceptedReservations.push(res);
                    //brisi iz Created liste
                    var idx = _this.createdReservations.indexOf(reservation);
                    _this.createdReservations.splice(idx, 1);
                }
            });
        });
    };
    HostRequestsComponent.prototype.rejectRequest = function (event) {
        var _this = this;
        var target = event.target || event.srcElement || event.currentTarget;
        var idAttr = target.attributes.id;
        var id = idAttr.nodeValue; //id kliknutog button-a
        this.hostService.changeUserStatus(id, 'Rejected').subscribe(function (data) {
            var res = _this.acceptedReservations.find(function (x) { return x.ID == id; });
            if (res != undefined) {
                var idx = _this.acceptedReservations.indexOf(res);
                _this.acceptedReservations.splice(idx, 1);
...
var HostReservationsComponent = /** @class */ (function () {
    function HostReservationsComponent(hostService, fb) {
        this.hostService = hostService;
        this.fb = fb;
    ...
    HostReservationsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.hostService.getHostReservations(3).subscribe(function (data) {
            _this.hostReservations = data;
            _this.FiltredReservations = data;
        });
    };
    HostReservationsComponent.prototype.onSearch = function () {
        var _this = this;
        this.hostService.GetSearchHostReservations(this.searchForm.value.guestUsername, this.searchForm.value.reservationStatus).subscribe(function (data) {
            _this.FiltredReservations = data;
            console.warn(_this.FiltredReservations);
        });
    };
    HostReservationsComponent.prototype.reset = function () {
        this.FiltredReservations = this.hostReservations;
    };
    HostReservationsComponent.prototype.sortLow = function () {
        this.FiltredReservations.sort(function (a, b) { return a.TotalPrice - b.TotalPrice; });
    };
    HostReservationsComponent.prototype.sortHigh = function () {
        this.FiltredReservations.sort(function (a, b) { return b.TotalPrice - a.TotalPrice; });
    };
    ...
    return HostReservationsComponent;
}());
...
var UploadPictureComponent = /** @class */ (function () {
    function UploadPictureComponent(hostService, router, storageService) {
        this.hostService = hostService;
        this.router = router;
        this.storageService = storageService;
        this.selectedFile = null;
    }
    UploadPictureComponent.prototype.onSelectFile = function (event) {
        var _this = this;
    ...
    UploadPictureComponent.prototype.onDone = function () {
    ...
    UploadPictureComponent.prototype.onConfirm = function () {
        var fd = new FormData();
        fd.append('image', this.selectedFile, this.selectedFile.name);
        this.hostService.uploadDocument(fd, this.apartmantID).subscribe(function () {
...
var HostComponent = /** @class */ (function () {
    function HostComponent(hostService) {
        this.hostService = hostService;
    }
...
var LogInComponent = /** @class */ (function () {
    function LogInComponent(router, fb, logingService) {
        this.router = router;
        this.fb = fb;
    ...
    LogInComponent.prototype.onSubmit = function () {
        var _this = this;
        this.logingService.TryLog(this.loginForm.value.username, this.loginForm.value.password).subscribe(function (data) {
            _this.userInfo = data;
            console.log(_this.userInfo);
            localStorage.setItem('Role', _this.userInfo.Role);
            localStorage.setItem('ID', _this.userInfo.ID);
            if (_this.userInfo.Role == 'Admin') {
                _this.router.navigate(['/admin']);
            }
            else if (_this.userInfo.Role == 'Host') {
                _this.router.navigate(['/host']);
            }
            else if (_this.userInfo.Role == 'Guest') {
...
var LogedUserComponent = /** @class */ (function () {
    function LogedUserComponent(router) {
        this.router = router;
    }
    LogedUserComponent.prototype.ngOnInit = function () {
    };
    LogedUserComponent.prototype.logOut = function () {
        localStorage.removeItem('Role');
        localStorage.removeItem('ID');
        this.router.navigate(['/home']);
    };
    LogedUserComponent.prototype.changeProfil = function () {
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.TryLog = function (username, password) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json',
                "Authorization": "Basic " + btoa(username + ":" + password) })
        };
        return this.http.get(this.LogInUri + "Login", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(alert("Eror in LogIn service:  " + e.error.Message)); }));
        ;
    };
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(userService, fb, router) {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.userService.GetUser().subscribe(function (data) {
            _this.logedUser = data;
            console.log(_this.logedUser);
            _this.userForm = _this.fb.group({
                role: [_this.logedUser.Role, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                username: [_this.logedUser.UserName, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                name: [_this.logedUser.Name, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                surname: [_this.logedUser.Surname, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
                gender: [_this.logedUser.Gender, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]
            });
            _this.passForm = _this.fb.group({
    ...
    ProfileComponent.prototype.onSubmit = function () {
        ...
        this.userService.ProfileChange(this.logedUser).subscribe(function (data) {
            alert("Succesfuly changed");
            _this.returnBack();
        });
    };
    ProfileComponent.prototype.returnBack = function () {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        if (this.registerForm.value.password === this.registerForm.value.confirmPassword) {
            ...
            this.registUser.Password = this.registerForm.value.password;
            this.registUser.Gender = this.registerForm.value.gender;
            this.userService.Register(this.registUser).subscribe(function (data) {
                alert("Host was created");
                console.log(_this.registUser);
...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.getApartment = function () {
        return this.ApartmentStorage;
    };
    StorageService.prototype.setApartment = function (app1) {
        this.ApartmentStorage = app1;
    };
    StorageService.prototype.getHostApartment = function () {
        return this.HostApartmentStorage;
    };
    StorageService.prototype.setHostApartment = function (app1) {
        this.HostApartmentStorage = app1;
    };
    StorageService.prototype.getGuestApartment = function () {
        return this.GuestApartmentStorage;
    };
    StorageService.prototype.setGuestApartment = function (app1) {
        this.GuestApartmentStorage = app1;
    };
    StorageService.prototype.getApartmentID = function () {
        return this.apartmentID;
    };
    StorageService.prototype.setApartmentID = function (app1) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.Register = function (user) {
        ...
        return this.http.put(this.userUri + "Register", user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(console.error("Eror in User service:  " + e.error.Message)); }));
    };
    UserService.prototype.GetUser = function () {
        ...
        return this.http.get(this.userUri + "GetUser", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(console.error("Eror in User service:  " + e.error.Message)); }));
    };
    UserService.prototype.ProfileChange = function (user) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'Role': localStorage.Role }),
        };
        return this.http.patch(this.userUri + "ChangeUser", user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(console.error("Eror in User service:  " + e.error.Message)); }));
    };
